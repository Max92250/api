...
function getCurrentUser() {
    const userDataElement = document.getElementById('app');
    const userDataString = userDataElement.getAttribute('data-user');
    ...
    function setCartData(cartData) {
        const user = getCurrentUser();
        const storageKey = user ? 'user_cart_' + user.id : 'cart';
        console.log(localStorage.getItem('user_cart_' + user.id));
